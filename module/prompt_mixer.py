...
class UserIntentPrompt(PromptType):
    ...
    Based on the user’s query, you should respond with the number mapped to the user’s intent. If you are unable to determine the user’s intent, you should return the intent number 5.
